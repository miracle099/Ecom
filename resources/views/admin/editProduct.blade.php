                    ...
                    <div class="col-xl-10 col-lg-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <textarea class="form-control" name="productDescription" id="summernote" rows="3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="warrante">
                                                ...
                                                <option value="1" {{ $product->warranty == '0' ? 'selected' : ''}}>1</option>
                                                <option value="2" {{ $product->warranty == '0' ? 'selected' : ''}}>2</option>
                                                <option value="3" {{ $product->warranty == '0' ? 'selected' : ''}}>3</option>
                                                <option value="4" {{ $product->warranty == '0' ? 'selected' : ''}}>4</option>
                                            </select>
